...
//dependiendo de si es opera, firefox o crome activamos la api getuser
...
// SI EL NOMBRE DE LA ROOM QUE HEMOS INTRODUCIDO CONTIENE CARACTERES, 
//AVISAMOS DE QUE LA HEMOS CREADO O SI YA ESTABA, NOS HEMOS UNIDO
if (room !== '') {
...
// SI LA PETICION DE GETUSERMEDIA HA SIDO CANCELADA POR EL USUARIO O POR ALGUNA OTRA RAZON,
// INFORMAMOS DE QUE NO SE HA PODIDO REALIZAR
function handleUserMediaError(error){
	console.log('navigator.getUserMedia error: ', error);
}


//SI HEMOS SIDO LOS PRIMEROS EN ENTRAR AL CANAL, 
//SE NOS ACTIVA DE QUE HEMOS SIDO EL INICIADOR
...
// si somos los segundos en entrar a la sala ya tenemos el canal activo,
// por lo que la variable isChannelReady del otro user se trunca a TRUE
...
// PARA REPRODUCIR LOS MENSAJES DE TRAZAS QUE GENERA EL SERVER
socket.on('log', function (array){
  console.log.apply(console, array);
});

// REcibe los mensajes de otro Peer a traves del
...
// SI no hemos empezado aún, el tipo de strem es apto y el canal esta preparado, 
//creamos la conexion peer to peer, y la 
...
/////////////////////////////////////////////////////////
// REALIZAMOS LA CONEXION PEER TO PEER CON LAS IP DE CADA PEER,
// A PARTIR DE AQUI LA CONEXION SERA ENTRE PARES
function createPeerConnection() {
  ...
  if (isInitiator) {
    ...
    //si somos el initiator, cambiamos las variables que teniamos denegadas para
    // poder empezar a hablar, y habilitamos la posibilidad de enviar informacion
     //cuando cierra el otro peer, lo volvemos a desactivar
    sendChannel.onopen = handleSendChannelStateChange; 
    sendChannel.onmessage = handleMessage; 
    sendChannel.onclose = handleSendChannelStateChange;
  } else { // Joiner    
    // si somos el unido, nos preparamos igual para poder establecer la conexion de datos.
